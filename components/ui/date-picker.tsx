...
export const DateField: React.FC<DateFieldProps> = ({
  ...
  const commit = (next: Date | undefined) => {
    ...
    const formatted = format(next, DISPLAY_FORMAT);
        ...
        <div className="relative">
          <PopoverTrigger asChild>
            <button
              ...
              onClick={(e) => {
                if (allowInput) {
                  // Prevent the trigger click from bubbling so the user can
                  // type into the input without immediately opening the popover.
                  e.preventDefault();
                  e.stopPropagation();
                  setOpen(true);
                }
            ...
            >
              {allowInput ? (
                <input
                  ...
                  className="w-full bg-transparent text-left outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed"
                />
              ) : (
                <span
